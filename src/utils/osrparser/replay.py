# from https://github.com/spawn18/osu-replay-to-map/blob/master/replay.py
import logging
from utils.osrparser.enums import GameMode, Mod
...
class Replay(object):
    ...
    def __init__(self, replay_path):
        ...
        try:
            ...
            logging.info("[REPLAY][ERROR] Replay couldn't be opened")
